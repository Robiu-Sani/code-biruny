...
export default function OurServicesBanner() {
  const services = [
    ...
    },
    {
      ...
      tech: ["Kubernetes", "Terraform", "Jenkins", "GitHub Actions"],
    },
    {
      title: "Desktop Applications",
      description: "Native apps for Windows, Mac, and Linux",
      icon: <Monitor className="h-5 w-5 text-indigo-500" />,
      tech: ["Electron", ".NET", "Java", "Qt"],
    },
  ];
  ...
  const process = [
    ...
    {
      title: "Planning",
      description: "Create detailed specifications and roadmap",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="mx-auto max-w-3xl text-lg text-zinc-600 dark:text-zinc-300">
            End-to-end services to build, launch, and grow your digital products
          </p>
        </div>
          ...
          <div className="md:w-1/3">
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-lg border border-zinc-200 dark:border-zinc-700 shadow-sm">
              ...
              <p className="text-zinc-600 dark:text-zinc-300 mb-4">
                ...
                Node.js microservices, and MongoDB database.
              </p>
